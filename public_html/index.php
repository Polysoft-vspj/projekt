  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="container">
	  ...
	  <li class="nav-item" id="Clanky">
                ...
                <a class="nav-link js-scroll-trigger" href="clanky/index_clanky.php"><b>Články</b></a>
          ...
          <li class="nav-item" id="Zpravy">
            ...
            <a class="nav-link js-scroll-trigger" href="zpravy/index_zprava.php"><b>Zprávy</b></a>
                ...
                <a class="nav-link js-scroll-trigger" href="helpdesk/index_helpdesk.php"><b>Help Desk</b></a>
