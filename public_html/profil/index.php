...
<?php
                                            ...
                                            $name = $_SESSION['uzivatel_jmeno'];

                                            $Podminka = "WHERE jmeno='$name'";

											$sql = "select * from uzivatele ". $Podminka;
											...
											if ( mysqli_num_rows( $vysledek ) > 0 ) {
												...
												echo "<TD ALIGN=CENTER>" . "<A HREF='uprav_uziv.php?oc=$oc' class=\"btn btn-secondary\">Změnit login</A></TD>";
