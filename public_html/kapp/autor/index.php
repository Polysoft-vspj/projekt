    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
         ...
         <form action="nahratClanek.php" method="post" enctype="multipart/form-data" style="text-align: left" id="novy_clanek">
...
// submit form and get new records
          ...
          $('#novy_clanek').on('submit', function(event){
              event.preventDefault();

              if($('#Nazev_clanku').val() != '' && $('#Autor_clanku').val() != '')
