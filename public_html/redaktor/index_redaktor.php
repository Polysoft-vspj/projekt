...
<hr />
<div class="container" id ="clanky_redaktor">
...
<?php
											...
											if ( $_GET[ Nazev ] != "" )
												$Podminka = "WHERE Nazev_clanku LIKE '" . AddSlashes( $_GET[ Nazev ] ) . "%' AND Stav like 'podáno' OR  	'vráceno z důvodu tématické nevhodnosti'";
											else
												$Podminka = "  WHERE Stav LIKE 'podáno' OR  'vráceno z důvodu tématické nevhodnosti'";
