...
$sql = "INSERT INTO clanky (clanky_id, Nazev_clanku, Autor_clanku, url_clanku) values('$_POST[clanky_id]','$_POST[Nazev_clanku]','$_POST[Autor_clanku]', '$target_filee')";
...
<div class="form-group">
               <a href="index.php"><input type="submit" class="btn btn-danger" value="Nahrát dokument" name="submit"> </a>
</div>
